document.addEventListener("DOMContentLoaded", () => {
	...
	$(document)
		.on("submit", "#create_address_form", function (e) {
			e.preventDefault();
		...
		.on("click", "delete_address", function (e) {
			e.preventDefault();
		...
		.on("click", "confirm_delete_address_button", function () {
		...
		.on("click", ".address_card_footer .update_address", function () {
			let address_id = $(this).closest(".address_card").data("address_id");
